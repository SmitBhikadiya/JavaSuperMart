!(function (e) {
  ...
  function (e, t, n) {
    ...
    function i(e, t, n, i) {
      ...
      var v = {
        ...
        si: n ? n.si : 0,
        startTime: e.timeOrigin || (d ? d.navigationStart : 0),
        versions: { fl: n ? n.version : "", js: "2021.1.0", timings: 1 },
        pageloadId: t,
        location: p,
      };
      if ("function" == typeof e.getEntriesByType) {
        ...
        if (m && Array.isArray(m) && m.length > 0) {
          (v.timingsV2 = {}), (v.versions.timings = 2), delete v.timings;
          c(m[0], v.timingsV2);
        }
      }
      ...
      if (
        ...
        y.forEach(function (e) {
          ...
          window.__cfBeaconCustomTag &&
            (("object" != typeof window.__cfBeaconCustomTag ||
              Array.isArray(window.__cfBeaconCustomTag)) &&
              console.warn(
                'Invalid custom tag format. Please use the following format: { "first_key": "first_value", "second_key": "second_value" }'
              ),
            (t.ct = r(window.__cfBeaconCustomTag))),
            v.tempResources &&
              void 0 === v.tempResources[w] &&
              (v.tempResources[w] = []);
          var n = JSON.stringify(t).length;
          g + n < 62e3 && v.tempResources
            ? ((g += n), v.tempResources[w].push(t))
            : (w++, (g = 0));
        });
      }
      return JSON.stringify(v).length >= 64e3 && (v.resources = []), v;
    }
    function o(e) {
    ...
    function a() {
      ...
      return t >= 55 && !!n && "cellular" === n.type && n.downlinkMax <= 0.115;
    }
    function s(e) {
    ...
    !(function () {
      ...
      document.addEventListener("visibilitychange", function () {
        "hidden" === document.visibilityState && !o && a && ((o = !0), h());
      });
      var s = { lcp: void 0, cls: void 0, fid: void 0 },
        c = function (e) {
          "CLS" === e.name
            ? (s.cls = e.value)
            : "FID" === e.name
            ? (s.fid = e.value)
            : "LCP" === e.name && (s.lcp = e.value);
        };
      if (
        ...
        if (l)
          ...
          var v = t.getAttribute("src");
          if (v) {
            var m = new URLSearchParams(v.replace(/^[^\?]+\??/, "")),
              y = m.get("token");
            y && (r = { token: y });
          }
        }
      }
      if (e && r && (r.rayId || r.token)) {
        var g = r.token
            ? r.send && r.send.to
              ? r.send.to
          ...
          w = function () {
            ...
            if (t && r) {
              var o = "req_id=" + r.rayId,
                a = t.tempResources;
              if ((delete t.tempResources, !a)) return;
              a.forEach(function (e, n) {
                (t.resources = e),
                  0 != n && (t.bypassTiming = !0),
                  r &&
                    (1 === r.r && (t.resources = []),
                    d.sendObjectBeacon(o, t, function () {}, !1, g),
                    void 0 !== r.forward &&
                      void 0 !== r.forward.url &&
                      d.sendObjectBeacon(
                        o,
                        t,
                        function () {},
  ...
  function (e, t, n) {
    ...
    t.__esModule = !0;
    !(function (e) {
      (e[(e.Load = 1)] = "Load"), (e[(e.Additional = 2)] = "Additional");
    ...
    var r,
      ...
      v = function (e) {
        ...
        o &&
          ...
          p(function (e) {
            var n = e.isUnloading;
            o.takeRecords().map(i), n && (r.isFinal = !0), t();
          }));
      },
      m = function () {
        return (
